...
const Login = ({setIsAuthenticated}) =>{
    ...
    return (
        <Component>
            ...
            :
            <Wrapper>
                <TextField id="filled-basic" label="Name"     onChange={(e)=>{onInputChange(e)}} name='name' variant="filled" />
                <TextField id="filled-basic" label="Username" onChange={(e)=>{onInputChange(e)}} name='username' variant="filled" />
                <TextField id="filled-basic" label="Password" onChange={(e)=>{onInputChange(e)}} name='password' variant="filled" type='password'/>
