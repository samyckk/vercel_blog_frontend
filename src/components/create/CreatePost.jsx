...
const CreatePost = () => {
    ...
    const savePost = ()=>{
      ...
      axios.post("https://vercel-blog-backend.vercel.app/create", post,{headers}).then(response=>{
        console.log(response.data.msg);
        //Close Create Tab
        navigate("/home/?cat=All");
      }).catch(error=>{
        console.log("error publishing from front end", error.response.data.msg);
      });
    ...
    <>
      <Container>
        ...
        <StyleForm>
          ...
          <StyleInputBase placeholder="Title" name="title" onChange={(e) => handleCreate(e)}  />
